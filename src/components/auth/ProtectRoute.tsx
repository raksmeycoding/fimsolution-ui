...
interface ProtectedRouteProps {
    ...
    allowedRoles: ('ROLE_ADMIN' | 'ROLE_USER' | 'ROLE_ANNO' | 'ROLE_LOAN_USER')[];
}
...
const ProtectRoute: React.FC<ProtectedRouteProps> = ({children, allowedRoles}) => {
    ...
    useEffect(() => {
        ...
        const tokenToUse: string | undefined = tokenInCache || accessToken || undefined;
        ...
        if (!tokenToUse) {
            ...
            try {
                const userRoles: string[] = jwtDecode<JwtPayload & { roles: string[] }>(tokenToUse).roles;
